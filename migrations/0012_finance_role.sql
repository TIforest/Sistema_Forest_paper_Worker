...
CREATE TABLE user_roles_finance (
  identity_hash TEXT PRIMARY KEY,
  display_name TEXT NOT NULL,
  role TEXT NOT NULL CHECK (role IN ('producao', 'qualidade', 'comercial', 'financeiro', 'diretoria', 'admin')),
...
INSERT INTO user_roles_finance (
...
ALTER TABLE user_roles_finance RENAME TO user_roles;
